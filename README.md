...
Next, download the library jar file [here](https://github.com/logentries/le_android/raw/master/lib/LogentriesAndroid-2.0.jar) and place it in the /lib folder of your Android project.
